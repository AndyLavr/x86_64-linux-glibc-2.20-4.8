...
enum opt_code
{
  ...
  OPT_mbionic = 1066,                        /* -mbionic */
  OPT_mbmi = 1067,                           /* -mbmi */
  OPT_mbmi2 = 1068,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1069,                  /* -mbranch-cost= */
  OPT_mcld = 1070,                           /* -mcld */
  OPT_mcmodel_ = 1071,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1072, */                    /* -mcpu= */
  OPT_mcrc32 = 1073,                         /* -mcrc32 */
  OPT_mcx16 = 1074,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1075,            /* -mdispatch-scheduler */
  ...
  OPT_mhle = 1089,                           /* -mhle */
  OPT_mieee_fp = 1090,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1091,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1092,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1093,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1094, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1095,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1096,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1097,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1098,                /* -mlong-double-80 */
  OPT_mlwp = 1099,                           /* -mlwp */
  OPT_mlzcnt = 1100,                         /* -mlzcnt */
  OPT_mmmx = 1101,                           /* -mmmx */
  OPT_mmovbe = 1102,                         /* -mmovbe */
  OPT_mms_bitfields = 1103,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1104,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1105,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1106,                  /* -mno-push-args */
  OPT_mno_red_zone = 1107,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1108,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1109,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1110,                          /* -mpc32 */
  OPT_mpc64 = 1111,                          /* -mpc64 */
  OPT_mpc80 = 1112,                          /* -mpc80 */
  OPT_mpclmul = 1113,                        /* -mpclmul */
  ...
  OPT_std_gnu__98 = 1227,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1228,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1229, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1230, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1231,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1232,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1233, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1234, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1235,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1236, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1237, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1238, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1239,                     /* -std=legacy */
  OPT_symbolic = 1240,                       /* -symbolic */
  OPT_t = 1241,                              /* -t */
  OPT_time = 1242,                           /* -time */
  OPT_time_ = 1243,                          /* -time= */
  OPT_tno_android_cc = 1244,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1245,                 /* -tno-android-ld */
